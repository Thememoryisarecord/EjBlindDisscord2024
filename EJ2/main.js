...
function Convertir()
{
    ...
    if (moneda1.value == "ARS" && moneda2.value == "GBP"){
        total = parseFloat(num * 0.00097);
        document.getElementById("totalNuevo").innerHTML = total + " GBP" ;
    }
    if (moneda1.value == "ARS" && moneda2.value == "TRY"){
        total = parseFloat(num * 0.037);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    } 
    if (moneda1.value == "GBP" && moneda2.value == "CLP"){
        total = parseFloat(num * 1132.46);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    } 
    if (moneda1.value == "GBP" && moneda2.value == "ARS"){
        total = parseFloat(num * 1032.25);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    } 
    if (moneda1.value == "GBP" && moneda2.value == "USD"){
        total = parseFloat(num *1.2);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    } 
    if (moneda1.value == "GBP" && moneda2.value == "TRY"){
        total = parseFloat(num * 37.95);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    }
    if (moneda1.value == "TRY" && moneda2.value == "CLP"){
        total = parseFloat(num * 29.81);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    }
    if (moneda1.value == "TRY" && moneda2.value == "ARS"){
        total = parseFloat(num * 27.20);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    }
    if (moneda1.value == "TRY" && moneda2.value == "USD"){
        total = parseFloat(num * 0.034);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    } 
    if (moneda1.value == "TRY" && moneda2.value == "GBP"){
        total = parseFloat(num * 0.026);
        document.getElementById("totalNuevo").innerHTML = total + " TRY" ;
    } 
   if (moneda1.value == moneda2.value)
   {
        document.getElementById("totalNuevo").innerHTML = "No valido " ;        
   }
